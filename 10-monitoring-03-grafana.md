...
![screen](/screen/10-monitoring-2-1.png)
...
<details>
<summary> Изучите самостоятельно ресурсы:</summary>
...
<code>avg by(instance)(rate(node_cpu_seconds_total{job="nodeexporter",mode="idle"}[$__rate_interval])) * 100</code>
- CPULA 1/5/15;
<code>
...
<code>avg(node_memory_MemFree_bytes{instance="nodeexporter:9100",job="nodeexporter"})
avg(node_memory_MemAvailable_bytes{instance="nodeexporter:9100", job="nodeexporter"})</code>
- количество места на файловой системе.
<code>node_filesystem_free_bytes{fstype="ext4",instance="nodeexporter:9100",job="nodeexporter"}
</code>
...
![screen](/screen/10-monitoring-2-3.png)
...
<code>
{
  ...
  "time": {
    "from": "2023-09-10T21:52:45.627Z",
    "to": "2023-09-11T12:53:04.055Z"
  },
  "timepicker": {},
  "timezone": "",
  "title": "nodeexplorer Copy",
  "uid": "If2nCMiSk",
  "version": 4
}
</code>
